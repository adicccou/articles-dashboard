...
export function TradingStrategyForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (invalid.length > 0) {
      setError(
        "Trading Assets should only contain symbols like XAUUSD, US500, BTCUSD, AUDUSD, XTIUSD, or EURUSD. Add strategy rules in the knowledge base after creating the strategy.",
      );
      return;
    }
      ...
      <section className="trading-form__section">
        ...
        <div className="trading-form__group">
          ...
          <textarea
            ...
            placeholder="XAUUSD, US500, BTCUSD, AUDUSD, XTIUSD"
            className="trading-form__textarea"
            rows={3}
          />
          <p className="trading-form__helper">
          ...
          <p className="trading-form__helper">
            Use asset symbols only, like `XAUUSD`, `US500`, `BTCUSD`, `AUDUSD`, or `XTIUSD`. Add your strategy rules in the knowledge base after saving.
          </p>
        </div>
